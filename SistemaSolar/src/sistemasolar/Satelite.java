...
public class Satelite extends Astro {
	...
	public enum DatosSatelite {
		TIERRA(1.2, 1.00000261, 0.98594, 1.0),
		LUNA(0.273, ESCALA_ORBITA_SATELITE * 0.00257, ESCALA_ORBITA_SATELITE * 0.002566, 0.0739),
		MERCURIO(0.6,0.50001305,0.49297,1.0),
		VENUS(1.0,0.8333550833,0.8216166667,1.0),
		MARTE(0.8,0.6666840666,0.6572933334,1.0),//orbita mal
		JUPITER(2.0,1.6667101665,1.643233335,1.0),//aparece lejos
		SATURNO(1.6,1.3333681332,1.314586668,1.0),
		URANO(1.35,1.1250293624,1.1091825011,1.0),
		NEPTUNO(1.25,1.0833616082,1.0681016677,1.0);;
