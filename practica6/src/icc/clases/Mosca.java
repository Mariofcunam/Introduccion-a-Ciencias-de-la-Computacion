...
public class Mosca {
	 ...
	 */
         public String canta(){
	     String vocal = Character.toString(this.vocal);
	     String original = "Una mosca parada en la pared, \n" +
                                    "en la pared, en la pared. \n" +
                                    "Una mosca, una mosca, \n" +
                                    "una mosca parada en la pared";
	     String nuevaFrase = original.replace("u",vocal).replace("U", vocal).replace("o",vocal).replace("e",vocal);
	     return nuevaFrase;
